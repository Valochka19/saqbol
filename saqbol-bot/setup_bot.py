...
DESCRIPTION = (
    ...
    "Пришлите мне текст, скриншот или номер — скажу, мошенники это или нет, и объясню почему. "
...
SHORT = "Проверю сообщение, скриншот или номер на мошенничество. Сақ бол — будь осторожен."
