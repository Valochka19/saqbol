...
const PLANS: { key: PlanKey; name: string; price: string; unit: string; who: string; items: string[]; cta: string; tone: string }[] = [
  ...
  },
  {
    ...
    items: ["Ссылка-приглашение для сотрудников", "Тренажёр и разговоры с «мошенником»", "Отчёт руководителю: кто прошёл и на чём ошибаются", "Свидетельство о прохождении под именем вашей компании", "Новые схемы каждый месяц"],
