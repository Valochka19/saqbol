    ...
    <div className="grid gap-x-10 gap-y-10 lg:grid-cols-[1.3fr_1fr]">
      <div>
        ...
        <p className="mt-3 max-w-[60ch] text-[16px] leading-relaxed text-ink-2">
          Пройдите тренажёр — и получите именной сертификат с оценкой устойчивости к мошенникам. Его можно распечатать,
          приложить к резюме или показать работодателю и банку: подлинность проверяется по QR-коду.
        </p>
